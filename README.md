...
# 💼 Kriangkrai Yothi Portfolio v2.0
...
**Kriangkrai Yothi Portfolio v2.0** คือเว็บไซต์แสดงผลงานส่วนตัวที่ออกแบบมาด้วย **Material Design 3** พร้อมด้วยสีสันและการออกแบบที่สวยงามตามหลักการของ Google Messages Landing Page เน้นความทันสมัย ใช้งานง่าย และรองรับทุกอุปกรณ์
...
* **Liquid Ether Effect:** เอฟเฟกต์ของเหลวเคลื่อนไหวตามเมาส์ (Interactive Fluid Simulation)
...
| **Graphics** | ![Three.js](https://img.shields.io/badge/Three.js-000000?style=flat-square&logo=three.js&logoColor=white) (WebGL Liquid Effect) |
...
│   │   ├── LiquidEther.tsx    #   • WebGL Fluid Simulation Effect
│   │   └── LoadingScreen.tsx  #   • Circular Wavy Loading Animation
│   ├── types/                 # - Type Definitions
│   │   └── index.ts           #   • Shared Config & Types
...
- ✅ Animated gradient mesh background with Liquid Ether effect
...
<div align="center">
  <sub>Built with ❤️ using React, TypeScript, and Tailwind CSS • Inspired by Google Messages Design • Version 2.0</sub>
</div>
